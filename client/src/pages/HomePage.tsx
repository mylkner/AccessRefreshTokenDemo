...
const HomePage = () => {
    const linkClass: string =
        "w-[20%] text-center px-5 py-3 bg-blue-500 hover:bg-blue-700 rounded transition-colors cursor-pointer";

    return (
        <div className="flex flex-col gap-4 items-center justify-center h-screen w-full text-white text-2xl">
            <span className="mb-10">Access and Refresh Token Demo</span>
